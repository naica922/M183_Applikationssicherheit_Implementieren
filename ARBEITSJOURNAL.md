...
| 14.06.2026 |  | <ul><li>User Entity und Repository erstellt (DB-Zugriff für Benutzer)</li><li>Registrierung im Backend implementiert (Argon2-Hashing, Input-Validierung, Audit-Log)</li></ul> | <ul>-</ul> |
