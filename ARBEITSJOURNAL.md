...
| 14.06.2026 | 40 | <ul><li>Login im Backend implementiert (Argon2-Verifizierung, JWT Access-Token, Refresh-Token als HttpOnly-Cookie)</li></ul> | <ul>-</ul> |
| 15.06.2026 |  | <ul><li>Refresh-Token-Rotation und Logout implementiert (alte Tokens werden invalidiert)</li></ul> | <ul>-</ul> |
